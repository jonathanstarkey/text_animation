...
(function(a) {
    ...
    k = {
        initDataClasses: function(b) {
            ...
            j(b.dataClasses, function(g, h) {
                ...
                d.push(g);
                if (!g.color)
                    f.dataClassColor === "category" ? (p = e.options.colors, g.color = p[o++], o === p.length && (o = 0)) : g.color = c.tweenColors(a.Color(f.minColor), a.Color(f.maxColor), h / (b.dataClasses.length - 1))
            })
        },
    ...
    a.extendClass(a.seriesTypes.gauge, {
        ...
        animate: function(b) {
            if (!b)
                this.startAngleRad = this.yAxis.startAngleRad, a.seriesTypes.pie.prototype.animate.call(this, b)
        }
    })
})(Highcharts);
